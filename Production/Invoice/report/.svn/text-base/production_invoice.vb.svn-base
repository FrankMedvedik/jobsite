...
Public Class production_invoice
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Production.production_invoice.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedproduction_invoice
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As production_invoice = New production_invoice()
        rpt.Site = Me.Site
        Return rpt
    End Function
